...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="post-inner">
		...
		<div class="entry-content">
			...
			<?php
				the_content( __( 'Continue reading', 'igual' ) );
			?>
	...
	<?php
		wp_link_pages(
			array(
				'before'      => '<nav class="post-nav-links bg-light-background" aria-label="' . esc_attr__( 'Page', 'igual' ) . '"><span class="label">' . esc_html__( 'Pages:', 'igual' ) . '</span>',
				'after'       => '</nav>',
