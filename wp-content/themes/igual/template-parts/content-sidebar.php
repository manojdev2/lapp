...
$template = Igual_Wp_Elements::$template;
...
if( $sidebar_layout != 'no-sidebar' ):
	...
	if( $sidebar_layout == 'left-sidebar' ){
		Igual_Wp_Elements::igual_get_template_sidebars( $page_title_values, 'left', 'col-md-4 order-md-1' );
	}elseif( $sidebar_layout == 'right-sidebar' ){
		Igual_Wp_Elements::igual_get_template_sidebars( $page_title_values, 'right', 'col-md-4 order-md-3' );
		...
		Igual_Wp_Elements::igual_get_template_sidebars( $page_title_values, 'left', 'col-md-'. esc_attr( $col ) .' order-md-1' );
		Igual_Wp_Elements::igual_get_template_sidebars( $page_title_values, 'right', 'col-md-'. esc_attr( $col ) .' order-md-3' );
	}
endif;