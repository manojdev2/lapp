...
use FuseWPVendor\Composer\Installer\BinaryInstaller;
use FuseWPVendor\Composer\Installer\LibraryInstaller;
use FuseWPVendor\Composer\IO\IOInterface;
use FuseWPVendor\Composer\Package\PackageInterface;
use FuseWPVendor\Composer\Repository\InstalledRepositoryInterface;
use FuseWPVendor\Composer\Util\Filesystem;
use FuseWPVendor\React\Promise\PromiseInterface;
