...
class CEA_Elementor_Pricing_Table_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			"title_stat",
			[
				"label" 		=> esc_html__( "Active/Inactive", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "This is option for set title status active or inactive.", 'classic-elementor-addons-pro' ),
