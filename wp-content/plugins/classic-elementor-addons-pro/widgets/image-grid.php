	...
	protected function register_controls() {
		...
		/*$this->add_control(
			...
			[
				...
				"label"			=> esc_html__( "Custom Image Size", 'classic-elementor-addons-pro' ),
				"description"	=> esc_html__( "Enter custom image size. You must specify the semi colon(;) at last then only it'll crop. eg: 200x200;", 'classic-elementor-addons-pro' ),
				"default" 		=> "",
				"condition" 	=> [
					"image_size" 		=> "custom"
				]
		...
		$this->add_control(
			"hard_croping",
			[
				"label" 		=> esc_html__( "Image Hard Crop", 'classic-elementor-addons-pro' ),
