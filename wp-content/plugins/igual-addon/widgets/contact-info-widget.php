<?php
class Igual_Contact_Infos_Widget extends WP_Widget {
	/**
	 * Widget setup.
	 */
	function __construct() {
		
		//add_action( 'admin_enqueue_scripts', array( $this, 'Igual_Contact_Infos_Widget_script' ) );
		add_action( 'load-widgets.php', array( &$this, 'Igual_Contact_Infos_Widget_script' ) );
		
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'igual_contact_info_widget', 'description' => esc_html__('A widget that displays an About widget', 'igual-addon') );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'igual_contact_info_widget' );
		parent::__construct( 'igual_contact_info_widget', esc_html__('Igual Contact Info', 'igual-addon'), $widget_ops, $control_ops );
		
	}
	
	function Igual_Contact_Infos_Widget_script(){
		wp_enqueue_style( 'wp-color-picker' );
        wp_enqueue_script( 'wp-color-picker' );
	}
	
	public function igual_shortcode_rand_id(){
	...
	function widget( $args, $instance ) {
		...
		$shortcode_css = '';
		$shortcode_rand_id = $rand_class = 'shortcode-rand-' . $this->igual_shortcode_rand_id();
		...
		if( $shortcode_css ) $class .= ' ' . $shortcode_rand_id . ' igual-inline-css';
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => esc_html__( 'Contact Info', 'igual-addon' ), 'ctext' => '', 'caddress' => '', 'cphone' => '', 'cmail' => '', 'font_color' => '', 'cfshortcode' => '', 'background_color' => '', 'background_img' => '' );
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ctext' ) ); ?>"><?php esc_html_e( 'Text Message', 'igual-addon' ); ?></label>
		...
		<!-- Address -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'caddress' ) ); ?>"><?php esc_html_e( 'Address', 'igual-addon' ); ?></label>
		...
		<!-- Phone Numbers -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'cphone' ) ); ?>"><?php esc_html_e( 'Phone Numbers', 'igual-addon' ); ?></label>
		...
		<!-- Email -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'cmail' ) ); ?>"><?php esc_html_e( 'Email', 'igual-addon' ); ?></label>
		...
		<!-- Shortcode -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'cfshortcode' ) ); ?>"><?php esc_html_e( 'Contact Form Shortcode', 'igual-addon' ); ?></label>
		...
		<!-- Font Color -->		
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'font_color' ) ); ?>"><?php esc_html_e( 'Font Color', 'igual-addon' ); ?></label>
		...
		<!-- Background Color -->
		<p>
            <label for="<?php echo $this->get_field_id( 'background_color' ); ?>"><?php _e( 'Background Color', 'igual-addon' ); ?></label>
            <span><?php _e( 'Choose widget background color', 'igual-addon' ); ?></span>
		...
		<!-- Background Image -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'background_img' ) ); ?>"><?php esc_html_e( 'Background Image', 'igual-addon' ); ?></label>
