 ...
 * @see Walker_Nav_Menu
 */
class Igual_Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	/**
	...
	public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<?php 
				/* Custom code */ 
				$igual_advance_menu = true;
				if( $igual_advance_menu ):
				?>
				<p class="field-igual-custom-settings description-wide">
					<label for="edit-menu-item-custom-settings-<?php echo $item_id; ?>">
						<span><?php esc_html_e( 'Igual Custom', 'igual-addon' ); ?></span>
						<?php
						printf(
							'<a href="#igual-general-settings-form" class="item-general-settings igual-general-settings-form" data-menu="%1$s" data-depth="%2$s">%3$s</a>',
							esc_attr( $item_id ),
							esc_attr( $depth ),
							esc_html__( 'Settings', 'igual-addon' )
						);
						$igual_menu = $item->igualmenu ? $item->igualmenu : json_encode( array( "icon" => "", "megamenu" => "", "megamenucol" => "", "megamenuwidget" => '' ));
						?>
						<textarea id="edit-menu-item-igual-<?php echo $item_id; ?>" class="widefat edit-menu-item-igual screen-reader-text" rows="3" cols="20" name="menu-item-igualmenu[<?php echo $item_id; ?>]"><?php echo esc_html( $igual_menu ); // $item->igualmenu textarea_escaped ?></textarea>
					</label>
				</p>
				<?php endif; 
				/* Custom code end */ 
