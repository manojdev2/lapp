...
class CEACPT { 
	...
	function __construct(){
		...
		$this->cpt_array =  array( 'portfolio' => esc_html__( 'Portfolio', 'cea-post-types' ), 'team' => esc_html__( 'Team', 'cea-post-types' ), 'testimonial' => esc_html__( 'Testimonial', 'cea-post-types' ), 'event' => esc_html__( 'Events', 'cea-post-types' ), 'service' => esc_html__( 'Services', 'cea-post-types' ) );
	...
	public function ceaCPTReadyRegister(){
		...
		$cat_needs = array( 'portfolio', 'service' );
		$tag_needs = array();
