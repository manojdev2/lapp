											...
											if ($date_exist):
												if ((time() - (60 * 60 * 24)) > strtotime($date_exist)):
													...
													<div class="alert alert-warning event-closed" role="alert">
														<span
															class="fa fa-exclamation-triangle"></span><?php echo apply_filters('cea_event_close', esc_html('Event closed.', 'cea-post-types')); ?>
													</div>
												<?php
															...
															switch ($elem):
																...
																<div class="col-sm-<?php echo esc_attr($event_col[$i++]); ?>">
																	<div class="event-info">
																		<h4><?php echo apply_filters('cea_event_info_details', 'Event Details'); ?>
																		</h4>
																		<?php
																		...
																		if ($organizer): ?>
																			<p class="event-organizer">
																				...
																				<?php if ($organizer_desg): ?>
																					<span class="event-organizer-designation">
																						<?php echo esc_html($organizer_desg); ?></span>
																				<?php endif; ?>
																			</p><?php
																		endif;
																		...
																		if ($event_link): ?>
																			<p class="event-cost">
																				...
																				<a class="btn btn-default"
																					...
																					target="<?php echo esc_attr($event_target); ?>"><?php echo esc_html($event_text); ?></a>
																			</p><?php
																		endif;
																...
																<div class="col-sm-<?php echo esc_attr($event_col[$i++]); ?>">
																	<div class="event-venue">
																		<h4><?php echo apply_filters('cea_event_venue_name', 'Event Venue'); ?>
																		</h4>
																...
																if ($lat):
																	...
																	<div class="col-sm-<?php echo esc_attr($event_col[$i++]); ?>">
																		<div class="event-map">
																			...
																			<div id="ceagmap" class="ceagmap"
																				style="width:100%;height:<?php echo absint($map_height); ?>px;"
