													...
													if ($email):
														...
														<div class="col-md-6 team-email-wrap">
															<div class="team-media media">
																<div class="team-details-icon"><i class="fa fa-envelope"></i>
																</div>
																<div class="media-body">
																	<span
																		class="team-email-label"><?php esc_html_e('Email', 'igual-addon') ?></span>
																	<a href="mailto:<?php echo esc_attr($email); ?>"
																		class="team-email"><?php echo esc_html($email); ?></a>
																</div>
															</div><!-- .team-media -->
														</div><!-- .team-email-wrap -->
													...
													if ($phone):
														...
														<div class="col-md-6 team-phone-wrap">
															<div class="team-media media">
																...
																<div class="media-body">
																	<span
																		class="team-phone-label"><?php esc_html_e('Phone', 'igual-addon') ?></span>
																	<a href="tel:<?php echo esc_attr(trim($phone)); ?>"
																		class="team-phone"><?php echo esc_html($phone); ?></a>
																</div>
															</div><!-- .team-media -->
														</div><!-- .team-phone-wrap -->
													...
													if ($website):
														...
														<div class="col-md-6 team-website-wrap">
															<div class="team-media media">
																...
																<div class="media-body">
																	<span
																		class="team-website-label"><?php esc_html_e('Website', 'igual-addon') ?></span>
																	<a href="<?php echo esc_url(trim($website)); ?>"
																		class="team-website"><?php echo esc_html($website); ?></a>
																</div>
															</div><!-- .team-media -->
													...
													if ($experience):
														...
														<div class="col-md-6 team-experience-wrap">
															<div class="team-media media">
																...
																<div class="media-body">
																	<span
																		class="team-details-label"><?php esc_html_e('Experience', 'igual-addon') ?></span>
																	<span
																		class="team-experience"><?php echo esc_html($experience); ?></span>
																</div>
															</div><!-- .team-media -->
														...
														if ($social_url): ?>
															<li>
																<a class="<?php echo esc_attr($key); ?>"
																	...
																	target="<?php echo esc_attr($taget); ?>">
